...
<body>
            ...
            <div class="collapse navbar-collapse text-start" id="navbarNav">
                <ul class="navbar-nav container row">
                    ...
                    <li class="d-lg-none nav-item justify-lg-content-end">
                        <a class="nav-link active" href="../espacePerso.php"><?= $_SESSION['login'] ?></a>
                    </li>
    ...
    <h1 class="text-center fw-bold pt-5 pb-5">Bienvenue sur ton espace, <?= $_SESSION['login'] ?></h1>

    <p class="text-center mainText fw-bold fs-4 m-auto">Ici tu pourras consulter tes voyages passés, ceux à venir et raconter tes expériences! N'hésite pas à parcourir nos catégories pour trouver ton prochain voyage et le rajouter à ta Wishlist!</p>

    <div class="text-center pb-5 pt-3">
        <a href="carnet.php"><button class="btn btn-dark">Carnet de voyage</button></a>
        <a href="wishlist.php"><button class="btn btn-dark">Wishlist</button></a>
        <a href="edit.php"><button class="btn btn-dark"> Rédiger un article</button></a>
    </div>
