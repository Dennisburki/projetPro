...
<div class="text-white text-center fs-4 fst-italic">Choisissez votre prochaine destination et partagez vos expériences</div>
    ...
    <?php } else { ?>
        ...
        <div class="text-center pb-5 pt-3 m-0">
            <div class="row m-0">
                <div class="col-lg-6">
                    <a href="addDestination.php"><button type="submit" class="btn col-lg-4 text-white addButton">Ajouter une destination</button></a>
                </div>

                <div class="col-lg-6">
                    <a href="updateDestination.php"><button type="submit" class="btn col-lg-4 updateButton text-white">Modifier une destination</button></a>
